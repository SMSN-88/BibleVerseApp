...
namespace BibleVerseGenApp
{
    public class BibleService
    {

        public static string FormatReference(BibleVerse verse)
        {
            string bookName = GetBookName(verse.Book);
            return $"{bookName} {verse.Chapter}:{verse.Verse} ({verse.Translation})";
        }
            ...
            var books = new Dictionary<int, string>
    {
        ...
        { 66, "Revelation" }
            ...
            return books.TryGetValue(bookNumber, out var name) ? name : $"Book {bookNumber}";
        }
        }
